...
export default {
	...
	//	Register commands
		this.subscriptions.add(atom.commands.add('atom-workspace', {
			...
			'web-tools:tables:html': () =>				this.tables('html'),
			'web-tools:tables:adoc': () =>				this.tables('adoc'),
			'web-tools:tables:md': () =>				this.tables('md'),
			'web-tools:tables:ascii': () =>				this.tables('ascii'),
			'web-tools:tables:box': () =>				this.tables('box'),
		}));
	},
...
*/
	...
	tables(type) {
		...
		switch(type) {
			case 'adoc':
				data=WebTools.adocTable(selection);
				break
			case 'md':
				data=WebTools.gfmTable(selection);
				break
			case 'ascii':
				data=WebTools.asciiTable(selection);
				break
			case 'box':
				data=WebTools.boxTable(selection);
				break
			case 'html':
			default:
